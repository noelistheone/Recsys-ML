...
if __name__ == '__main__':
    models = {
        ...
        'Self-Supervised Graph-Based Models': ['SGL', 'SimGCL', 'SEPT', 'MHCN', 'BUIR', 'SelfCF', 'SSL4Rec', 'XSimGCL', 'NCL', 'MixGCF', 'CPTPP', 'PT4Rec', 'PT4Rec_Unlearn', 'PT4Rec_Pop', 'PT4Rec_Adv', 'PT4Rec_Gate'],
